      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogTrigger asChild>
          <Button
            ...
            className="border-amber-300 hover:bg-amber-400 hover:border-amber-400 hover:text-white border-2 bg-transparent cursor-pointer text-amber-300"
          >
            Crie sua conta
          </Button>
        </DialogTrigger>
        <DialogContent className="w-full max-w-sm">
          ...
          >
            <DialogHeader>
              <DialogTitle className="">Cadastro de Professor</DialogTitle>
              <DialogDescription>Faça seu cadastro</DialogDescription>
            </DialogHeader>
            <Form {...form}>
              <div>
                <FormField
